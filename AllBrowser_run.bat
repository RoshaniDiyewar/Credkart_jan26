...
pytest -n=0 --html=Html_reports\my_firefoxreport_31st_jan_2026.html --browser firefox -k "test_verify_Credkart_url_001" --alluredir=AllureReports
pytest -n=0 --html=Html_reports\my_edgereport_31st_jan_2026.html --browser edge -k "test_verify_Credkart_url_001" --alluredir=AllureReports