...
from pageObjects.RagistrationPage import Registration_Page_Class
from utilities.Logger import log_generator_class
from utilities.ReadProperties import ReadConfigClass
from utilities.XLUtiils import Excel_methods
...
class Test_User_Profile :
    ...
    excel_path = ".\\TestData\\Credkart_Test_Data.xlsx"
